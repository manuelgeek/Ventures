	...
	public function dataview($query)
	{
		...
		if($stmt->rowCount()>0)
		{
			while($row=$stmt->fetch(PDO::FETCH_ASSOC))
			{
              ...
              <div class="col-md-6  col-xs-12 col-sm-6 row-eq-height card" id="mauni">
                
                <?php if ( $row['photo']==''){
                 echo ""; 
                }else {?>
                	
                	 <img  src="news_page/connect_images/<?php echo $row['photo']; ?>"  class="item_image img-responsive" />
               ...
               <span class="phoned"> <b>Phone:</b><?php echo $row['contact']; ?><br></span>
               <span class="phoned"> <b>Location:</b><?php echo $row['location']; ?><br></span>
               <span class="priced"> <b>Rates:</b><?php echo $row['price']; ?><br></span>
               <span class="phoned"> <b>Website link:</b><a target="_blank" href="https://<?php echo $row['linked']; ?>"><?php echo $row['linked']; ?></a><br></span>
